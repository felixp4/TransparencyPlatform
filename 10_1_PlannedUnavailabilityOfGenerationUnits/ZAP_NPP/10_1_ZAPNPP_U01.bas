...
Sub Main()
    ...
    Dim strmRID, strGeneratorNumber, strCurrentDate, strFromDate As String
    strGeneratorNumber = "62W086969517524B"
...
'         Next j
    ...
    '' set Reason
        ...
        Set Code = doc.createElement("code")
        Set tagText = doc.createTextNode("B20")
        Code.appendChild (tagText)
        ...
        xmlFileName = ThisWorkbook.Path & "\01_10.1_ZAPNPP-U01.xml"
        Smooth_Xml doc
