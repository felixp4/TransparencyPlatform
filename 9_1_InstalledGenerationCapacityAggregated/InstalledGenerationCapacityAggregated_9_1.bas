...
Sub Main()
    ...
    ''time_Period.timeInterval
        ...
        StartValue = Format(shDataAll.Cells(4, 4).Text & " " & shDataAll.Cells(4, 5).Text, "yyyy-mm-ddThh:mmZ") '+++
        ...
        endValue = Format(shDataAll.Cells(4, 6).Text & " " & shDataAll.Cells(4, 7).Text, "yyyy-mm-ddThh:mmZ")   '+++
...
'' set TimeSeries - loop
   For i = 1 To 2
    ...
    ''set MktPSRType
        ...
        Set tagText = doc.createTextNode(shDataAll.Cells(3 + i, 8).Text)
    ...
    '' timeInterval
         ...
         StartValue = Format(shDataAll.Cells(3 + i, 4).Text & " " & shDataAll.Cells(3 + i, 5).Text, "yyyy-mm-ddThh:mmZ")   '+++
         ...
         endValue = Format(shDataAll.Cells(3 + i, 6).Text & " " & shDataAll.Cells(3 + i, 7).Text, "yyyy-mm-ddThh:mmZ")   '+++
    ...
    '' set  time interval
         ...
         Set tagText = doc.createTextNode("P1Y")
         ...
         ' For j = 1 To 24
            ...
            Set tagText = doc.createTextNode(shDataAll.Cells(3 + i, 3).Text)    ' --- Потужність
            ' shDataDay.Cells(2, 3 + j).Value = naek(j)
            ' Set tagText = doc.createTextNode(shDataAll.Range("B4").Value)
   ...
   Next i
        ...
        xmlFileName = ThisWorkbook.Path & "\18_9.1_NNEGC.xml"
        Smooth_Xml doc
